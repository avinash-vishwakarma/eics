...
function pieChart(e, t, o, r = "270") {
    var a = {
        ...
        responsive: [
            { breakpoint: 1399, options: { chart: { width: "100%" } } },
        ],
    };
...
const customTooltips = function (e) {
    ...
    chartLinearGradient = (e, a, t) => {
        ...
        return (
            r.addColorStop(0, "" + t.start), r.addColorStop(1, "" + t.end), r
        );
    };
    ...
    if (l) {
        ...
        new Chart(l, {
            ...
            options: {
                        ...
                        callbacks: {
                            label: function (e) {
                                ...
                                return (
                                    a && (a += ": "),
                                    null !== e.parsed.y &&
                                        (a += new Intl.NumberFormat().format(
                                            e.parsed.y
                                        )),
                ...
                layout: {
                    padding: { left: -13, right: -10, top: 0, bottom: 0 },
                },
        ...
        n.forEach(function (e, n) {
            ...
            new Chart(e, {
                ...
                options: {
                    ...
                    layout: {
                        padding: { left: -13, right: 0, top: 0, bottom: 0 },
                    },
                    elements: { point: { radius: 0 } },
                    scales: {
                        y: {
...
function fOverviewYear() {
    chartjsLineChartOne(
        ...
        (bColor = "#20C997"),
        (data = [
            95e3, 19e3, 55e3, 9e4, 24e4, 95e3, 55e3, 19e3, 55e3, 66e3, 9e4,
            24e4,
        ])
    ),
        chartjsLineChartOne(
            ...
            (bColor = "#FF69A5"),
            (data = [
                98e3, 2e4, 55e3, 9e4, 24e4, 95e3, 55e3, 19e3, 55e3, 66e3, 9e4,
                24e4,
            ])
        ),
        chartjsLineChartOne(
            ...
            (bColor = "#5F63F2"),
            (data = [
                9500, 1900, 5500, 9e3, 24e3, 9500, 5500, 1900, 5500, 9e3, 1e4,
                24e3,
            ])
        ),
        chartjsLineChartOne(
            ...
            (bColor = "#FA8B0C"),
            (data = [
                5e3, 19e3, 15e3, 19e3, 2e4, 35e3, 2e4, 19e3, 27e3, 1e4, 15e3,
                2e4,
            ])
        );
}
...
!(function (e) {
            ...
            e.get(
                ...
                (t) => {
                    ...
                    void 0 !== i && (s = s.attr("id", i)),
                        void 0 !== l &&
                            (s = s.attr("class", l + " replaced-svg")),
                        (s = s.removeAttr("xmlns:a")),
                        !s.attr("viewBox") &&
                            s.attr("height") &&
                            s.attr("width") &&
                            s.attr(
                                `viewBox 0 0  ${s.attr("height")} ${s.attr(
                                    "width"
                                )}`
                            ),
                        a.replaceWith(s);
    ...
    s &&
        ...
        e(window)
            .bind("resize", function () {
                window.innerWidth;
                e(this).width() > 767.98 &&
                    e(".dm-mail-sidebar").addClass("show");
            })
            .trigger("resize"),
        e(window)
            .bind("resize", function () {
    ...
    q &&
        ...
        e(".job-value2").text(
            e(".price-slider").slider("values", 1) + " miles"
        ),
        ...
        e.addEventListener("mouseover", function () {
            ...
            (s.style.top = t.top + "px"),
                "ltr" === z
                    ...
                    : "rtl" === z &&
                      (s.style.right =
                          Math.round(0.75 * e.offsetWidth) + 10 + "px");
        });
    });
