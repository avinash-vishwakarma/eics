                    ...
                    <section class="about-section fix section-padding section-bg">
                        <div class="container">
                            <div class="about-wrapper">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-8 wow fadeInUp" data-wow-delay=".4s">
                                        <div class="about-image">
                                            <img src="{{asset("img/about/about.jpg")}}" alt="img">
                                            <div class="border-shape">
                                                <img src="{{asset("img/about/border-shape.png")}}" alt="shape-img">
                                            </div>
                                            <div class="video-image">
                                                <img src="{{ asset("img/about/video.jpg") }}" alt="img">
                                                <div class="video-box">
                                                    <a href="https://www.youtube.com/watch?v=Y7zIZVlMtFY" class="video-btn ripple video-popup">
                                    ...
                                    <div class="col-xl-6 col-lg-8 mt-5 mt-xl-0">
                                        <div class="about-content">
                                            <div class="section-title">
                                                <span class="wow fadeInUp">ABOUT EICS</span>
                                                <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                                    Expert Engineering Services for Iron & Steel Plants Since 1997
                                                </h2>
                                            </div>
                                            ...
                                            <div class="about-info-items wow fadeInUp" data-wow-delay=".9s">
                                                <a href="{{ route("about") }}" class="theme-btn-2">
